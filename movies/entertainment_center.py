...
#each movie object needs the movie title, a description, its
#poster image's url and the trailer url to be instantiated


#Hidden Figures
hidden_figures = media.Movie("Hidden Figures",
"The incredible untold story of Katherine G. Johnson, Dorothy"
...
"Compelled to abduct three teenage girls, Kevin reaches a war"
" for survival among all of those contained within him - as well"
" as everyone around him - as the walls between his compartments shatter apart.",
...
"At first, Chris reads his girlfriend's family's overly"
" accommodating behavior as nervous attempts to deal with their"
" daughter's interracial relationship, but as the weekend"
" progresses, a series of increasingly disturbing discoveries"
...
"Pride & Prejudice is a romantic drama based on Jane Austen's"
...
"Swan Lake requires a dancer who can play both the White Swan"
" with innocence and grace, and the Black Swan, who represents"
" guile and sensuality. Nina fits the White Swan role perfectly"
" but Lily is the personification of the Black Swan.",
...
"Lazy stoner Dale Denton has only one reason to visit his"
" equally lazy dealer Saul Silver: to purchase weed,"
" specifically, a rare new strain called Pineapple Express.",
